...
Not informed data could be generated using the `--not-informed` build script option. With this mode the nor-informed schema will be generated by the way and every column will have a 0.1 rate of not-informed data.
